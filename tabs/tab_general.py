...
def display_tab_general():
    ...
    if 'reformulacao_aviso' not in st.session_state:
        ...
        with aviso_container.container():
            ...
            with col1:
                st.markdown("""
                    <div style='background-color: #f8f9fa; padding: 20px; border-radius: 10px; margin-bottom: 20px; border-left: 4px solid #3B82F6;'>
                        <h3 style='color: #1F2937; margin-top: 0; margin-bottom: 15px;'>🎉 A aba Análise do Dia foi reformulada!</h3>
                        <div style='color: #4B5563; font-size: 14px; line-height: 1.6;'>
                            <p style='margin-bottom: 10px;'><strong>Novidades implementadas:</strong></p>
                            <ul style='margin-top: 0; padding-left: 20px;'>
                                <li>Projeção do dia com base no progresso atual</li>
                                <li>Gráfico de receita por hora em barras</li>
                                <li>Métricas mais detalhadas por origem, mídia, campanha, conteúdo, termo e página</li>
                                <li>Visualização mais clara e intuitiva dos dados</li>
                                <li>Análise de itens vendidos com filtros avançados</li>
                            </ul>
                        </div>
                    </div>
                """, unsafe_allow_html=True)
    ...
    # Aviso da nova aba Itens Vendidos (só aparece na primeira vez após o login)
    if 'itens_vendidos_aviso' not in st.session_state:
        # Criar um container vazio para o aviso
        aviso_container = st.empty()
        ...
        with aviso_container.container():
            ...
            with col1:
                st.markdown("""
                    <div style='background-color: #f8f9fa; padding: 20px; border-radius: 10px; margin-bottom: 20px; border-left: 4px solid #22C55E;'>
                        <h3 style='color: #1F2937; margin-top: 0; margin-bottom: 15px;'>🆕 Nova aba: Itens Vendidos!</h3>
                        <div style='color: #4B5563; font-size: 14px; line-height: 1.6;'>
                            <p style='margin-bottom: 10px;'><strong>Funcionalidades disponíveis:</strong></p>
                            <ul style='margin-top: 0; padding-left: 20px;'>
                                <li>Análise detalhada de produtos vendidos</li>
                                <li>Filtros avançados por cluster, origem, mídia e mais</li>
                                <li>Ranking dos produtos mais vendidos</li>
                                <li>Métricas de receita e quantidade por produto</li>
                                <li>Análise por cluster de tráfego</li>
                            </ul>
                            <p style='margin-top: 15px; font-style: italic;'>Acesse a nova aba no menu lateral para explorar essas funcionalidades!</p>
                        </div>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with col2:
                ...
                """, unsafe_allow_html=True)
                if st.button("✕", key="fechar_aviso_itens", help="Fechar aviso"):
                    aviso_container.empty()
                    st.session_state.itens_vendidos_aviso = True
