...
from helpers.notices import send_critical_error
...
def display_tab_paid_media(client, table, df_ads, username):
    try:
        ...
        error_details = "Erro ao carregar dados da aba de Mídia Paga. Verifique se todas as integrações estão funcionando corretamente."
        send_critical_error(username, str(e), error_details)
        st.error("Ocorreu um erro ao carregar os dados. Nossa equipe foi notificada e está trabalhando na solução.")
